		...
		<el-card>
			<el-form ref="formRef" :model="form" :rules="rules" label-width="120px" style="max-width: 700px">
				...
				<el-form-item>
					...
					<el-button @click="loadCheckRecordDetail">重置为原数据</el-button>
...
<script setup>
	...
	const loadCheckRecordDetail = async () => {
		try {
	...
	const handleSubmit = () => {
		formRef.value.validate(async (valid) => {
			...
			try {
				...
				console.log('编辑体检提交数据：', submitData)
